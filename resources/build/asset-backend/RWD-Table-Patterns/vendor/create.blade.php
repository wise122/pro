                    ...
                    <div class="card-body">
                        <form action="{{ route($route.'store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    {!! Form::text('start_date', null, ['class'=>'form-control weeklyDatePicker', 'placeholder' => 'Pilih Tanggal', 'autocomplete' => 'off']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-4 col-form-label" for="example-input-normal">Sampai Tanggal</label>
                                <div class="col-8">
                                    {!! Form::text('end_date', null, ['class'=>'form-control from_date', 'placeholder' => 'Pilih Tanggal Dari', 'autocomplete' => 'off', 'readonly']) !!}
                                </div>
                            </div>
