                        ...
                        <form action="{{ route($route.'update', $data->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    ...
                                    <br>
                                    <div id="holder">
                                        <a href="{{ $data->cover }}" target="_blank">Lihat Video</a>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    {!! Form::text('link', $data->link, ['class' => 'form-control', 'placeholder' => 'Masukkan Link', 'autocomplete' => 'off']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-4 col-form-label" for="example-input-normal">Title</label>
                                <div class="col-8">
                                    {!! Form::text('title', $data->title, ['class' => 'form-control', 'placeholder' => 'Masukkan Title', 'autocomplete' => 'off']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-4 col-form-label" for="example-input-normal">Status</label>
                                <div class="col-8">
                                    {!! Form::select('status', ['0' => 'Tidak Aktif', '1' => 'Aktif'], $data->status, ['placeholder' => 'Silahkan Pilih Status', 'class' => 'form-control select2']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-4 col-form-label" for="example-input-normal">Urutan</label>
                                <div class="col-8">
                                    {!! Form::number('urutan', $data->urutan, ['class' => 'form-control', 'placeholder' => 'Urutan', 'autocomplete' => 'off']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-4 col-form-label" for="example-input-normal">Description</label>
                                <div class="col-8">
                                    {!! Form::textarea('description', $data->description, ['class' => 'form-control summernote']) !!}
                                </div>
                            </div>
