...
@section('css')
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/prof.css') }}">
@endsection
...
@section('content')
                    ...
                    <div class="grow pl-20 md:pl-28 relative">
                        <div class="absolute left-0 bottom-0">
                            <picture class="border rounded-full block relative h-16 w-16 md:h-24 md:w-24 overflow-hidden">
                                <img src="{{ asset('asset/images/avatar-propaktani.jpeg') }}"
                                    alt="{{ auth()->user()->name }}" class="bg-white absolute object-cover w-full h-full" />
                            </picture>
                        </div>
                        <div>
            ...
            <div class="md:flex divide-x divide-slate-100 min-h-[320px]">
                <div class="w-full md:w-72 flex-none">
                    <nav class="bg-white border-b border-b-slate-100">
                        <ul class="nav-user-left">
                            ...
                            <li class="active">
                                <a href="{{ route('frontend.penjualan') }}">
                                    <span class="text-xl">
                                        <i class="las la-user"></i>
                                    </span>
                                    Menjual Produk
                ...
                <div class="grow px-3 md:px-8 pb-10">
                    ...
                    <fieldset class="mb-4">
                        ...
                        <div class="text-sm">
                            Jl. Kelak kelok, No. 20. Kelurahan Sukaresmi, Kecamatan Tanah Sareal <br />
                            Kota Bogor, Jawa Barat 16165, Indonesia
                            / <i>Belum diisi</i>
                        </div>
                    </fieldset>
                    <div class="grid grid-cols-2 gap-x-4 gap-y-6">
                        <fieldset>
                            <div class="text-xs mb-1 uppercase tracking-[1px] text-slate-500">Institusi</div>
                            <div class="text-sm">
                                <i>Belum diisi</i>
                            </div>
                        </fieldset>
                    ...
                    <div class="border-t py-4">
                        ...
                        @if ($komoditasProdusen)
                            <div class="grid md:grid-cols-2 gap-x-6 lg:gap-x-10 gap-y-10">
                                @foreach ($komoditasProdusen as $key => $komoditas)
    ...
    <div class="modal fade" id="modalKomoditasTambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-scrollable max-w-2xl">
            <form method="post" action="{{ route('frontend.submit-komoditas-produsen') }}" enctype="multipart/form-data"
                class="modal-content">
                @csrf
                    ...
                    <fieldset class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="alamat" type="text" class="form-control" id="Alamat"
                                placeholder="Contoh: Nama Kecamatan, Nama Kota/Kabupaten, Nama Propinsi">
                        </div>
                    </fieldset>
                    <fieldset class="mb-3">
