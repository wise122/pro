                    ...
                    <div class="card-body">
                        <form action="{{ route($route.'update', $data->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    {!! Form::text('title', $data->judul, ['class' => 'form-control', 'placeholder' => 'Masukkan Judul', 'autocomplete' => 'off', 'autofocus' => 'true']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-4 col-form-label" for="example-input-normal">Tipe Buku</label>
                                <div class="col-8">
                                    {!! Form::text('no_hp', $data->no_hp, ['class' => 'form-control', 'placeholder' => 'Masukkan No Hp', 'autocomplete' => 'off']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
