                        ...
                        <div class="card-body">
                            <form action="{{ route($route . 'update', $data->id) }}" method="POST"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        {!! Form::select('tipe_buku', ['berbayar' => 'Berbayar', 'gratis' => 'Gratis'], $data->tipe_buku, [
                                            'placeholder' => 'Silahkan Pilih Tipe Buku',
                                    ...
                                    <div class="col-8">
                                        ...
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="height: 150px;">
                                                <img class="h-100" src="{{ asset('storage/books/' . $data->cover) }}">
                                            </div>
                                            <div class="fileinput-preview fileinput-exists thumbnail"
                                                style="max-width: 200px; max-height: 150px; line-height: 10px;"></div>
                                            <div>
