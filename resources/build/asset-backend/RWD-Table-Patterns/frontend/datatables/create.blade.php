                    ...
                    <div class="card-body">
                        <form action="{{ route($route.'store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    {!! Form::text('pelaksanaan_awal', null, ['class'=>'form-control datetimepicker', 'placeholder' => 'Masukkan Pelaksaan Awal', 'autocomplete' => 'off']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-4 col-form-label" for="example-input-normal">Pelaksanaan Akhir</label>
                                <div class="col-8">
                                    {!! Form::text('pelaksanaan_akhir', null, ['class'=>'form-control datetimepicker', 'placeholder' => 'Masukkan Pelaksaan Akhir', 'autocomplete' => 'off']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    {!! Form::textarea('zoom', null, ['class'=>'form-control', 'placeholder' => 'Masukkan Link Zoom', 'rows' => 2]) !!}
                                </div>
                            </div>
                            <div class="form-group row">
