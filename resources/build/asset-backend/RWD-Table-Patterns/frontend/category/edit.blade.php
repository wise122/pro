                    ...
                    <div class="card-body">
                        <form action="{{ route($route.'update', $data->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::text('video_id', $data->youtube_id, ['class'=>'form-control', 'placeholder' => 'Masukkan Video Id', 'autocomplete' => 'off']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 control-form-label">Judul</label>
                                <div class="col-sm-10">
                                    {!! Form::text('judul', $data->judul, ['class'=>'form-control', 'placeholder' => 'Masukkan Judul', 'autocomplete' => 'off']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 control-form-label">Tanggal</label>
                                <div class="col-sm-10">
                                    {!! Form::text('tgl', $data->tanggal, ['class'=>'form-control datepicker', 'placeholder' => ' Masukkan Tanggal', 'autocomplete' => 'off']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 control-form-label">Episode</label>
                                <div class="col-sm-10">
                                    {!! Form::number('episode', $data->episode, ['class'=>'form-control', 'placeholder' => 'Masukkan Episode', 'autocomplete' => 'off']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="height: 150px;">
                                            <img src="{{asset('storage/bts/'.$data->cover)}}">
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <label>
                                        <input type="radio" name="status" value="publish" {{ $data->status == 'publish' ? 'checked':'' }}>
                                        <span>Publish</span>
                                    </label>
                                    <label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <label>
                                        <input type="radio" name="active" value="yes" {{ $data->active == 'yes' ? 'checked':'' }}>
                                        <span>Ya</span>
                                    </label>
                                    <label>
                                        <input type="radio" name="active" value="no" {{ $data->active == 'no' ? 'checked':'' }}>
                                        <span>Tidak</span>
                                    </label>
                                </div>
                            </div>
